...
Hospitalization_Rates = alt.Chart(Prototype1).mark_bar().encode(
    ...
    color=alt.Color('legend:N', scale=alt.Scale(domain=['COVID 19 Hospitalization Rate in Exposed Population (%):Q', 'COVID 19 Hospitalization Rate in Unexposed Population (%):Q'], range=['orange', 'blue'])),
