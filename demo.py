...
fig_combined.update_layout(title='COVID Hospitalization Rate & Circulating Variants Over Time', xaxis_title='Month-Year', width=1200, height=600,legend=dict(orientation='h', yanchor='bottom', y=1, xanchor='right', x=1))
